...
test('Parse SQL Query', () => {
    ...
    expect(parsed).toEqual({
        ...
        joinType: null,
        groupByFields: null,
        hasAggregateWithoutGroupBy: false, isDistinct: false, limit: null, orderByFields: null,
    });
});
...
test('Parse COUNT Aggregate Query', () => {
    ...
    expect(parsed).toEqual({
        ...
        whereClauses: [],
        groupByFields: null,
        hasAggregateWithoutGroupBy: true, isDistinct: false, limit: null, orderByFields: null,
        "joinCondition": null,
        "joinTable": null,
        "joinType": null,
    });
