...
test('Parse SQL Query', () => {
    ...
    expect(parsed).toEqual({
        fields: ['id', 'name'],
        table: 'sample',
        isDistinct: false, limit: null, orderByFields: null, whereClauses: null,
        joinCondition:null,
        joinTable : null,
        joinType : null,
        table : "student",
...
test('Parse SQL Query with WHERE Clause', () => {
    ...
    expect(parsed).toEqual({
        fields: ['id', 'name'],
        table: 'student',
        isDistinct: false, limit: null, orderByFields: null, whereClauses: [{field : "age", operator : "=", value : "25"}],
        joinCondition : null,
        joinTable : null,
        joinType: null,
        groupByFields : null,
